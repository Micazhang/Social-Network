...
<div class="post-body {if $_lightbox}pt0{/if}">
    ...
    <div class="post-actions">
        {if $user->_logged_in}
            <!-- like -->
            <span class="text-clickable mr20 {if $photo['i_like']}text-active js_unlike-{if $photo['is_single']}post{else}photo{/if}{else}js_like-{if $photo['is_single']}post{else}photo{/if}{/if}">
