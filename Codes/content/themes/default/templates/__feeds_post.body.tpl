...
<div class="post-header">
    ...
    <div class="post-meta">
        ...
        <div class="post-time">
            ...
            -
            {if !$_shared && $_post['manage_post'] && $_post['user_type'] == 'user' && $_post['post_type'] != "product" && $_post['post_type'] != "article"}
                <!-- privacy -->
                {if $_post['privacy'] == "me"}
...
{if $_post['post_type'] == "album" || ($_post['post_type'] == "product" && $_post['photos_num'] > 0) || $_post['post_type'] == "photos" || $_post['post_type'] == "profile_picture" || $_post['post_type'] == "profile_cover"}
