        ...
        <div class="comment-data">
            ...
            <div>
                ...
                <span class="js_comment-likes {if {$_comment['likes']} == 0}x-hidden{/if}">
                    ·
                    <span class="text-link" data-toggle="modal" data-url="posts/who_likes.php?comment_id={$_comment['comment_id']}"><i class="fa fa-thumbs-o-up"></i> <span class="js_comment-likes-num">{$_comment['likes']}</span></span>
                </span>
                ·
