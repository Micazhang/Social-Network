...
// valid inputs
/* if (last_request || last_notification) not set */
if(!isset($_POST['last_request']) || !isset($_POST['last_notification'])) {
	_error(400);
}
/* if (last_request || last_notification) not numeric */
if(!is_numeric($_POST['last_request']) || !is_numeric($_POST['last_notification'])) {
	_error(400);
}
